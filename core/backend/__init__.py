...
from core.backend.database.config import MailConfig, DevelopmentConfig, ProductionConfig
...
def create_app():
    ...
    with app.app_context():
        ...
        from .accounts.components.accounts_context import accounts_context, inject_now
